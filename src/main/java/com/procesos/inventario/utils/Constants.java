...
public class Constants {
    ...
    public static final String REGISTER_UPDATE_BAD = "Hubo un error al actualizar el registro!";
    ...
    public static final String REGISTER_LIST = "Lista de registros encontrado!";
}
